...
const DElEdBooks = () => {
  ...
  const [filteredBooks, setFilteredBooks] = useState<Book[]>(
    books.filter(book => book.category === 'D.El.Ed Books')
  );
  ...
  const handleSearch = () => {
    const filtered = books.filter((book) => {
      ...
      const matchYear = !selectedYear || book.year === selectedYear;
      return matchSubject && matchYear && book.category === 'D.El.Ed Books';
    });
    ...
    <div className="min-h-screen bg-bookstore-cream">
      ...
      <main className="pt-24 pb-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl md:text-4xl font-bold text-bookstore-navy mb-8">D.El.Ed Books</h1>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md mb-8">
            ...
            <Button className="mt-6 w-full" onClick={handleSearch}>Search D.El.Ed Books</Button>
          </div>
